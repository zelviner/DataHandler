...
std::shared_ptr<ScriptInfo> Script::scriptInfo(const std::string &error) {
    ...
    //             script_info_->clear_filename = std::string::fromStdString(file.name());
    //         } else {
    ...
    //             script_info_->check_filename = std::string::fromStdString(file.name());
    //         } else {
    ...
    //             script_info_->post_person_filename = std::string::fromStdString(file.name());
    ...
    //             script_info_->person_filename = std::string::fromStdString(file.name());
    //         } else {
